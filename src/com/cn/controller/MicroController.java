...
import com.cn.dao.impl.MicroDaoImpl;
...
public class MicroController extends Controller {
	private IMicroDao microDao = new MicroDaoImpl();
	...
	public void addItem() {
		...
		i.setModifier(CookieUtil.getCookieByName(getRequest(),
				CookieUtil.USERNAME));
